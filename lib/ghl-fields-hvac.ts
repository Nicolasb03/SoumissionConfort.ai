// Custom field IDs for the HVAC sub-account (legacy "Powerflow Leads").
// IDs are unique to that GHL location; do not reuse in another sub-account.

import type { GHLFieldDef } from './ghl-fields'

export const GHL_FIELDS_HVAC: Record<string, GHLFieldDef> = {
